...
const BrigadeFilters: React.FC<BrigadeFiltersProps> = ({ connectionStates, departments, handleDepartmentChange, handleConnectionChange }) => {
    return (
        <Flex className='filter-flex-container' gap="middle">
            <Select size="middle" className="filter-select-connection" placeholder="Соединение" allowClear onChange={handleConnectionChange}>
            ...
            <Select placeholder="Департамент" className="filter-select-department" allowClear onChange={handleDepartmentChange}>
